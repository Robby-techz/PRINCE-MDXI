...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~GALZTYuk7jRwCXO5kcRu", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
TIME_ZONE: process.env.TIME_ZONE || "Africa", // Enter yours else leave blank if not sure
};
